function HeroSection() {
  return (
    <div className="bg-[#F5F5FA]">
      <div className="mx-3 sm:mx-12 xsm:mx-20 md:mx-[148px]">
        <p className="font-bold  text-[24px] md:text-[40px] text-center pt-7">
          Every tool you need to work with PDFs in one place
        </p>
        <p className=" text-[#47474f] text-center text-[12px] md:text-[20px]">
      ...
      <div className=" py-6 p-2 sm:p-12 space-y-2 hover:cursor-pointer gap-1 h-fit sm:space-y-0  sm:grid xsm:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5">
        <div className=" p-6 bg-white drop-shadow-lg space-y-2  shadow-black rounded-md hover:bg-[#F6F6FB]">
          <div className="merge flex space-x-2  xsm:flex-col space-y-2">
            <svg
              className="hover:scale-110 vvsm:block "
            ...
            <p className="font-semibold font-sans items-center text-[18px] xsm:hidden">
              Merge PDF
            </p>
          </div>
          <p className=" hidden lg:block font-semibold font-sans text-[18px] xsm:block">
            Merge PDF
          </p>
        ...
        <div className=" p-6 bg-white drop-shadow-lg space-y-2  shadow-black rounded-md hover:bg-[#F6F6FB]">
          <div className="Compress flex space-x-2  xsm:flex-col space-y-2">
            <svg
              className="hover:scale-110 vvsm:block"
              xmlns="http://www.w3.org/2000/svg"
              width="48"
          ...
          <p className=" font-semibold font-sans text-[18px] xsm:block">
            Compress PDF
          </p>
          <p className="font-sans text-[12px]">
        ...
        <div className=" p-6 bg-white drop-shadow-lg space-y-2  shadow-black rounded-md hover:bg-[#F6F6FB]">
          <div className="Split flex space-x-2  xsm:flex-col space-y-2">
            <svg
              className="hover:scale-110 vvsm:block"
              xmlns="http://www.w3.org/2000/svg"
              width="48"
        ...
        <div className=" p-6 bg-white drop-shadow-lg space-y-2  shadow-black rounded-md hover:bg-[#F6F6FB]">
          <div className="pdftow flex space-x-2  xsm:flex-col space-y-2">
            <svg
              className="hover:scale-110 vvsm:block"
              xmlns="http://www.w3.org/2000/svg"
              width="48"
        ...
        <div className=" p-6 bg-white drop-shadow-lg space-y-2  shadow-black rounded-md hover:bg-[#F6F6FB]">
          <div className="ptoppt flex space-x-2  xsm:flex-col space-y-2">
            <svg
              className="hover:scale-110 vvsm:block"
              xmlns="http://www.w3.org/2000/svg"
              width="48"
        ...
        <div className=" p-6 bg-white drop-shadow-lg space-y-2  shadow-black rounded-md hover:bg-[#F6F6FB]">
          <div className="ptoexcel flex space-x-2  xsm:flex-col space-y-2">
            <svg
              className="hover:scale-110 vvsm:block"
              xmlns="http://www.w3.org/2000/svg"
              width="48"
        ...
        <div className=" p-6 bg-white drop-shadow-lg space-y-2  shadow-black rounded-md hover:bg-[#F6F6FB]">
          <div className="edit flex space-x-2  xsm:flex-col space-y-2">
            <svg
              className="hover:scale-110 vvsm:block"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 100 100"
        ...
        <div className=" p-6 bg-white drop-shadow-lg space-y-2  shadow-black rounded-md hover:bg-[#F6F6FB]">
          <div className="Signature flex space-x-2  xsm:flex-col space-y-2">
            <svg
              className="hover:scale-110 vvsm:block"
              xmlns="http://www.w3.org/2000/svg"
              height="50"
        ...
        <div className=" p-6 bg-white drop-shadow-lg space-y-2  shadow-black rounded-md hover:bg-[#F6F6FB]">
          <div className="Unlock flex space-x-2  xsm:flex-col space-y-2">
            <svg
              className="hover:scale-110 vvsm:block"
              xmlns="http://www.w3.org/2000/svg"
              width="48"
        ...
        <div className=" p-6 bg-white drop-shadow-lg space-y-2  shadow-black rounded-md hover:bg-[#F6F6FB]">
          <div className="protect flex space-x-2  xsm:flex-col space-y-2">
            <svg
              className="hover:scale-110 vvsm:block"
              xmlns="http://www.w3.org/2000/svg"
              width="48"
